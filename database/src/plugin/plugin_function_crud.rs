...
) -> Result<(Vec<(plugin_function::Model, Option<plugin_package::Model>)>, String), DbErr> {
...
#[allow(dead_code)]
pub(crate) async fn delete_plugin_function(db: &DatabaseConnection, function_id: &str) -> Result<(), DbErr> {
...
mod tests {
	...
	async fn insert_test_function(db: &DatabaseConnection, id: &str, name: &str) -> Result<(), DbErr> {
